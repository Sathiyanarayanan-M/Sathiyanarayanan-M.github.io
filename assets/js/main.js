...
(function($) {
  ...
  if ($(window).width() < 362) {
    $('#project-cont').removeClass('container');
    $(".project-mf").css("width", "100%");
  }
  ...
  $(window).on('scroll', function() {
    ...
    if ($(window).scrollTop() > pixels) {
      $('.navbar-expand-md').addClass('navbar-dark bg-dark navbar-reduce');
      $('.navbar-expand-md').removeClass('navbar-trans');
      
    } else {
      if (!$('#navbarDefault').hasClass('show')) {
        $('.navbar-expand-md').removeClass('navbar-dark bg-dark navbar-reduce');
      }
